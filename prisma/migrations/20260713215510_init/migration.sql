-- CreateEnum
CREATE TYPE "AccountType" AS ENUM ('bank', 'cash', 'crypto', 'savings', 'credit', 'investment');
...
CREATE TABLE "Transaction" (
    ...
    "exchangeRateToUsd" DECIMAL(18,8) NOT NULL,
    "usdEquivalent" DECIMAL(18,4) NOT NULL,
    "merchant" TEXT,
...
-- CreateIndex
CREATE UNIQUE INDEX "Category_name_userId_kind_key" ON "Category"("name", "userId", "kind");
...
-- CreateIndex
CREATE UNIQUE INDEX "ExchangeRateCache_date_baseCurrency_key" ON "ExchangeRateCache"("date", "baseCurrency");
