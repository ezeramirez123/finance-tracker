...
export function InlinePeriodSelect({
  ...
  return (
    <div className="flex w-full items-center justify-between py-1 text-xs lg:justify-center lg:gap-3 lg:py-0 lg:text-sm">
      {OPTIONS.map((opt) => (
        <button
          key={opt.value}
          type="button"
          ...
          className={cn(
            "cursor-pointer rounded-full px-3 py-2.5 font-medium transition-colors lg:px-3 lg:py-1.5",
